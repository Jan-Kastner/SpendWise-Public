...
namespace SpendWise.DAL.DTOs
{
    ...
    public record UserDto : IDto
    {
        ...
        /// </remarks>
        public ICollection<InvitationDto> SentInvitations { get; init; } = new List<InvitationDto>();
        ...
        /// </remarks>
        public ICollection<InvitationDto> ReceivedInvitations { get; init; } = new List<InvitationDto>();
