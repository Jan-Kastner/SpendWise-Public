...
{
    public class InvitationEntityRelationsConfig : IIncludeSender, IThenGIncludeGroupUsers, IThenGGuIncludeUser, IInvitationEntityInitialState, IIncludeReceiver, IIncludeGroup
{
