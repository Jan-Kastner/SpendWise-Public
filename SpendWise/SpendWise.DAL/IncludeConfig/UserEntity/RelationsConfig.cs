...
{
    public class UserEntityRelationsConfig : IIncludeGroupUsers, IIncludeSentInvitations, IIncludeReceivedInvitations, IThenGuIncludeGroup, IUserEntityInitialState
{
